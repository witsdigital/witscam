...
<script type="text/javascript">
    ...
    function deleta() {
        window.location.href = '<?= base_url('usuario/apagar') ?>' + '/' + document.getElementById('id').value;
    ...
    <div class="box-body">
        <div class="box">
            <div class="box-header">
                <div align="right"><input  onclick="window.location.href = '<?= base_url() ?>usuario/cadastro'" type="button" value="Novo Usuário" class="btn btn-success"></button></div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($usuarios as $row) { ?>
                            <tr>
                                ...
                                <td style="width: 135px;"><button onclick="window.location.href = '<?= base_url() ?>usuario/alterar/<?php echo $row->idusuario; ?>'" class="btn btn-warning btn-flat">Alterar</button><button onclick="confirma(<?php echo $row->idusuario ?>);" class="btn confirma  btn-danger btn-flat" >Apagar</button></td>
