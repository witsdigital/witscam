                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="entidade" class="form-control">
                                    <option selected><?php
                                        $query = $this->db->get_where('entidade', array('id' => $usuarios[0]->entidade));
                                    ...
                                    $entidade = $query->result();
                                    foreach ($entidade as $row2) {
                                        ?>
                                        <option value="<?php echo $row2->id ?>"><?php echo $row2->tipo ?> de <?php echo $row2->nome ?></option>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url(); ?>usuario/updateimg" enctype="multipart/form-data" method="post">
