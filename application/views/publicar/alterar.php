...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <form action="<?= base_url(); ?>publicar/update" enctype="multipart/form-data" method="post">
                        <div class="box-body">
                            ...
                            <div class=" col-md-12">
                                <br><button type="submit" class="btn btn-primary">Salvar</button>       <button  onclick="window.location.href = '<?= base_url() ?>publicar'" type="button" value="Cancelar" class="btn btn-danger">Cancelar</button>
                            </div>
                            <!-- tools box -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url(); ?>publicar/upfile" enctype="multipart/form-data" method="post">
                            <input type="hidden" name="keyfile" value="<?php echo $publicacao[0]->keyarquivo ?>">
                            <input type="hidden" name="entidade" value="<?php echo $publicacao[0]->entidade ?>">
