                            ...
                            <tr>
                                ...
                                <td><?php
                                   ...
                                   <td><?php echo $row->valor ?></td>
                                      <td><?php echo date("d/m/Y", strtotime($row->data_mov)) ?>  </td>
                              
                                

                                <td align='center' style="width: 140px; "><button onclick="window.location.href = '<?= base_url('noticia/alterar') ?>/<?php echo $row->id ?>'" class="btn btn-warning btn-flat">Alterar</button>
