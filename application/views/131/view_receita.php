                    ...
                    <tbody>
                        <?php foreach ($data as $row) { ?>
                            <tr>
                                ...
                                <td align='center' style="width: 140px; "><button onclick="window.location.href = '<?= base_url('Um3Um/alterarreceita') ?>/<?php echo $row->cod ?>/<?php echo $row->id ?>'" class="btn btn-warning btn-flat">Alterar</button><button onclick="confirma(<?php echo $row->id ?>);" class="btn confirma  btn-danger btn-flat" >Apagar</button></td>
