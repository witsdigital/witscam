...
<script type="text/javascript">
    ...
    function deleta() {
        window.location.href = '<?= base_url('aviso/apagar') ?>' + '/' + document.getElementById('id').value;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url() ?>usuario">Notícias</a></li>
    ...
    <div class="box-body">
        <div class="box">
            <div class="box-header">
                 <div align="right"><input  onclick="window.location.href='<?= base_url()?>Um3Um/cadastro'" type="button" value="Novo Envio" class="btn btn-success"></button></div>
                    ...
                    <tbody>
                        <?php foreach ($data as $row) { ?>
                            <tr>
                                ...
                                <td align='center' style="width: 180px; "><button onclick="window.location.href = '<?= base_url('Um3Um/visualizar') ?>/<?php echo $row->cod ?>/<?php echo $row->arquivo ?>'" class="btn btn-primary btn-flat">Visualizar</button><button onclick="confirma(<?php echo $row->id ?>);" class="btn confirma  btn-danger btn-flat" >Apagar</button></td>
