...
<div class="content-wrapper">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th ><div align="right">Ação</div></th>
                    ...
                    <tbody>
                        ...
                        foreach ($dados as $rowa) {
                            ...
                            <tr>
                                <td <?php if ($i % 2 == 0) {
                            echo '{echo style="background-color:#f2f2f2;";}';
                        } ?> ><?php echo $rowa->arquivo ?></td>
                                <td  <?php if ($i % 2 == 0) {
                            echo '{echo style="background-color:#f2f2f2;";}';
                        } ?>><div align="right"> <button onclick="window.open('<?= base_url() ?>uploads/publicacao/<?php echo $entidade ?>/<?php echo $dirdata ?>/<?php echo $rowa->arquivo ?>')" class="btn viewpdf btn-primary">Visualizar</button>
    ...
    <?php $i++;
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?= base_url('publicacoes/print_publicacao') ?>/<?php echo $row->id ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Imprimir</a>
                <a href="<?= base_url('publicacoes') ?>" class="btn btn-primary"><i class="fa "></i> voltar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="window.location.href = '<?= base_url('publicacoes/delete_file') ?>/<?php echo $rowa->id ?>'"class="btn btn-primary">Apagar</button>
            </div>
        </div>
    </div>
</div>
