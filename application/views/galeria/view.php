...
<script type="text/javascript">
    ...
    function cadastro() {
       ...
       window.location.href = '<?= base_url('galeria/cadastro') ?>' ;
    ...
    function deleta() {
        window.location.href = '<?= base_url('galeria/apagar') ?>' + '/' + document.getElementById('id').value;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url() ?>especialidade"><?php echo $this->uri->segment(1); ?></a></li>
