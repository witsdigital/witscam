...
<script>
    function alterarimg(id) {
        ...
        window.location.href = '<?= base_url('galeria/alterarimg') ?>' + '/' + id;

    }
    function apaga(id, key) {

        window.location.href = '<?= base_url('galeria/apagarimg') ?>' + '/' + id + '/' + key;

    }
    function voltar(id) {

        window.location.href = '<?= base_url('galeria/alterar') ?>' + '/' + id;
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <form action="<?= base_url($this->uri->segment(1)); ?>/salvarimg"  onsubmit="return validarSenha(this)" enctype="multipart/form-data" method="post">
                        <div class="col-md-12">
                    ...
                    <br><button type="submit" class="btn btn-primary">Enviar</button> <button type="button" onclick="window.location.href = '<?= base_url($this->uri->segment(1)) ?>/alterar/<?= $chave ?>'" class="btn btn-danger">Cancelar</button>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($imgevento as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 200px;"><img width="100px" height="100px" src="<?= base_url() ?>uploads/galeria/<?php echo $row->arquivo ?>"></td>
