...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="<?= base_url(); ?>noticia/update"  onsubmit="return validarSenha(this)" enctype="multipart/form-data" method="post">
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-7">
                                ...
                                <input type="text" name="titulo" value="<?php echo $noticia[0]->titulo?>"  class="form-control" required placeholder="cidade">
                            </div>
                    ...
                    <div class=" col-md-12">
                        <br><button type="submit" class="btn btn-primary">Salvar</button> <button type="button" onclick="window.location.href='<?=  base_url('noticia')?>'" class="btn btn-danger">Cancelar</button>
                    </div>
                </form>
            </div><!-- /.box-body -->
