...
<script type="text/javascript">
    ...
    function deleta() {
        window.location.href = '<?= base_url('noticia/apagar') ?>' + '/' + document.getElementById('id').value;
    ...
    <div class="box-body">
        <div class="box">
            <div class="box-header">
                 <div align="right"><input  onclick="window.location.href='<?= base_url()?>noticia/cadastro'" type="button" value="Nova Noticia" class="btn btn-success"></button></div>
